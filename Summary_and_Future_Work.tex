...
\item Machine learning competitions have shown very clearly that an ensemble of distinct model predictions (ratings in this application) outperform individual model predictions \cite{mlwave}. Ensemble rating: weighted average of captain rating and club rating.
